...
func (g *Generator) Generate(program *ast.Program) string {
	...
	// Check if we need .env loading (env() calls or Discord code)
	needsEnvLoader := strings.Contains(userCodeStr, "process.env.") || g.hasCommandStatements(program) || strings.Contains(userCodeStr, "Discord")
